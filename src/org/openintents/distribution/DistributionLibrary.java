...
public class DistributionLibrary
{
	...
	/**
	 * Number of menu IDs that should be reserved for DistributionLibrary.
	 */
	...
	public DistributionLibrary(Activity activity, int firstMenuId,
			int firstDialogId)
	{
		mActivity = activity;
	...
	/**
	 * Typical usage: Put this code in the beginning of onCreate().
	 * 
	 * <pre>
	 ...
	 * </pre>
	 * 
	 * If one of the two activities is shown, they make sure that the calling
	 * intent is called again afterwards.
	 * 
	 * @param activity
	 * @return true if one of the dialogs is being shown. In this case,
	 *         onCreate() should be aborted by returning.
	 */
	...
	public void onCreateOptionsMenu(Menu menu)
	{
		...
		{
			menu.add(0, mFirstMenuId + OFFSET_UPDATE, 0,
					R.string.oi_distribution_menu_update)
					.setIcon(android.R.drawable.ic_menu_info_details)
					.setShortcut('9', 'u');
		}
		menu.add(0, mFirstMenuId + OFFSET_ABOUT, 0,
				R.string.oi_distribution_about)
				.setIcon(android.R.drawable.ic_menu_info_details)
				.setShortcut('0', 'a');
	}
	...
	public boolean onOptionsItemSelected(MenuItem item)
	{
		...
		case OFFSET_UPDATE:
			...
			return true;
		case OFFSET_ABOUT:
			AboutDialog.showDialogOrStartActivity(mActivity, mFirstDialogId
					+ OFFSET_ABOUT);
			return true;
		}
		return false;
	...
	public void onPrepareDialog(int id, Dialog dialog)
	{
		...
		{
		case OFFSET_ABOUT:
			DownloadAppDialog.onPrepareDialog(mActivity, dialog);
			break;
		}
	}
}
