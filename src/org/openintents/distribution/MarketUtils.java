...
public class MarketUtils
{
	...
	/**
	 * URI prefix to a package name to bring up the download page on the Android
	 * Market
	 */
	...
	{
		return IntentUtils.isIntentAvailable(context,
				getMarketDownloadIntent(packageName));
	}
