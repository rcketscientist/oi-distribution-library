...
public class UpdateDialog extends DownloadAppDialog
{
	...
	/**
	 * If any of the following applications is installed, there is no need for a
	 * manual "Update" menu entry.
	 */
	...
	{
		super(context, R.string.oi_distribution_update_box_text,
		...
		String appnameversion = mContext.getString(
				R.string.oi_distribution_name_and_version, appname, version);
		...
		setButton(mContext.getText(R.string.oi_distribution_update_check_now),
				this);
	}
